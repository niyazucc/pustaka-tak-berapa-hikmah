...
@section('content')
    <section class="bg-slate-50 py-8 antialiased dark:bg-gray-900 md:py-16">
        <div class="mx-auto max-w-2xl px-4 2xl:px-0">
            ...
            <p class="text-gray-500 dark:text-gray-400 mb-6 md:mb-8">Your order <a href="#" class="font-medium text-gray-900 dark:text-white hover:underline">#{{$order->id}}</a> will be processed within 24 hours during working days. We will notify you by email once your order has been shipped.</p>
            ...
            <div class="flex items-center space-x-4">
                <a href="{{route('customer.belian')}}" class="text-white bg-red-500 hover:bg-primary-800 focus:ring-4 focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none">View Purchase</a>
