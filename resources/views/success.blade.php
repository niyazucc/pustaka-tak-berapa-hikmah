    ...
    <section class="bg-slate-50 py-8 antialiased dark:bg-gray-900 md:py-16">
        <div class="mx-auto max-w-2xl px-4 2xl:px-0">
            ...
            <div class="flex items-center space-x-4">
                <a href="#" class="text-white bg-red-500 hover:bg-primary-800 focus:ring-4 focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none">Track your order</a>
